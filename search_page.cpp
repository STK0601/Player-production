...
SearchPage::SearchPage(QWidget *parent) : QWidget(parent) {
    ...
    // 内容区
    QLabel *content = new QLabel("关注的视频内容将显示在这里");
    ...
    connect(homeBtn, &QPushButton::clicked, this, &SearchPage::goHome);
    connect(bottomNav, &BottomNavigationBar::homeClicked, this, &SearchPage::goHome);
